...
namespace wcolors
{
WORD fgColors[] = { WHITE, CYAN, MAGENTA, YELLOW, LIGHT_GRAY, RED, GREEN, BLUE, DARK_YELLOW,
PURPLE, DARK_CYAN, DARK_GRAY, DARK_GREEN, DARK_BLUE, DARK_RED, BLACK };
WORD bgColors[] = { BG_WHITE, BG_CYAN, BG_MAGENTA, BG_YELLOW, BG_LIGHT_GRAY, BG_RED, BG_GREEN,
